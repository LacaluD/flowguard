...
def _validate_file_with_permissive_schema(tmp_path: Path, yaml_file: Path) -> int:
    schema_file = tmp_path / "schema.json"
    _write_permissive_schema(schema_file)
    return validate_against_schema(yml_path=yaml_file, schema_file=schema_file)


def test_unicode_yaml_is_valid(tmp_path: Path) -> None:
...
def test_bom_yaml_is_valid(tmp_path: Path) -> None:
...
def test_crlf_yaml_is_valid(tmp_path: Path) -> None:
...
def test_tabs_indentation_yaml_is_invalid(tmp_path: Path) -> None:
...
def test_deeply_nested_yaml_is_valid(tmp_path: Path) -> None:
